...
describe('test-.mjs::root-dirs: Test Suite for root-dirs Files', function() {
    ...
    describe ('test-.js::root-dirs: [Test A] Test Suite for root-dirs in main repo directory', function() {
        ...
        it('[Test A] Test for svn root using _getSvnRoot', function(done) {
            // let result = getroot._getSvnRoot(__dirname, { baseType: "svn", logger: console.log });
            // expect(result).to.equal("C:\\Users\\GB\\Documents\\projects\\requireurl\\get-root\\.svn");
            done();
        });

        it('[Test A] Test for svn root using getSvnRoot', function(done) {
